package com.vic.project.app_news.presentation.theme
 ...
 */
val LightAndroidBackgroundTheme = BackgroundTheme(color = backgroundLight)

/**
 * Dark Android background theme
 */
val DarkAndroidBackgroundTheme = BackgroundTheme(color = backgroundDark)
